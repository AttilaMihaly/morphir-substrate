...
- `tier_multiplier` — discount multiplier from the [Quantity Tier](pricing/quantity-tier.md)
- `promo_multiplier` — discount multiplier from the [Promo Discount](pricing/promo-discount.md)
