...
- [Subtract](../specs/language/number.md#subtraction)
  - `subtotal`
  - `discount_amount`
...
- [Add](../specs/language/number.md#addition)
  - `discounted_subtotal`
  - `tax_amount`
...
- [Greater Than or Equal](../specs/language/ordering.md#greater-than-or-equal)
  - `quantity`
  - `1`
...
- [Less Than or Equal](../specs/language/ordering.md#less-than-or-equal)
  - `discount_rate`
  - `1`
...
- [If-Then-Else](../specs/language/boolean.md#if-then-else)
  - `is_valid_discount`
  - `discount_rate`
  - `0`
...
[bool]: ../specs/language/boolean.md
[mul]: ../specs/language/number.md#multiplication
